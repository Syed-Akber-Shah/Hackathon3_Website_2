...
const CartPage = () => {
  ...
  const handleIncrement = (id: string) => {
    const product = cartItems.find((item) => item._id.toString() === id);
    if (product) {
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <div className="flex items-center mt-2">
                    <button 
                    onClick={() => handleDecrement(item._id.toString())} 
                    className="px-2 py-1 bg-gray-300 rounded-md hover:bg-gray-400"
                    >
                    -
                    </button>
                    <span className="mx-2">{item.inventory}</span>
                    <button onClick={() => handleIncrement(item._id.toString())} className="px-2 py-1 bg-gray-300 rounded-md hover:bg-gray-400">+</button>
                  </div>
                </div>
              </div>
              <button 
